...
sphere(pos = vec(-0.3, 0.1, -1.1), opacity = 1, size = vec(0.4,0.4,0.4), color = vector(0.99,0.96,0.9))
cylinder(pos = vec(-0.5,0,1.8), opacity = 1, size = vec(44,0.1,0.15), color = vector(0.82, 0.68, 3), axis = vec(0,30,0))
cylinder(pos = vec(-0.5,0,-1.8), opacity = 1, size = vec(44,0.1,0.15), color = vector(0.82, 0.68, 3), axis = vec(0,30,0))
cylinder(pos = vec(-0.5,0,0.35), opacity = 1, size = vec(44,0.1,0.15), color = vector(0.82, 0.68, 3), axis = vec(0,30,0))
cylinder(pos = vec(-0.6,0,-0.35), opacity = 1, size = vec(44,0.1,0.15), color = vector(0.82, 0.68, 3), axis = vec(0,30,0))
cylinder(pos = vec(-0.6,0,1.1), opacity = 1, size = vec(44,0.1,0.15), color = vector(0.82, 0.68, 3), axis = vec(0,30,0))
cylinder(pos = vec(-0.6,0,-1.1), opacity = 1, size = vec(44,0.1,0.15), color = vector(0.82, 0.68, 3), axis = vec(0,30,0))
